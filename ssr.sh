...
Set_config_password(){
	...
	stty erase '^H' && read -p "(默认: doudou):" ssr_password
	[[ -z "${ssr_password}" ]] && ssr_password="doudou"
...
Download_SSR(){
	cd "/usr/local/"
	wget -N --no-check-certificate "https://github.com/zhengongfu/nokia/blob/master/manyuser.zip"
